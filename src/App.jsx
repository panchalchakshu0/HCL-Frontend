        ...
        <BrowserRouter>
            <div className="min-h-screen bg-slate-50/50 text-slate-900 flex flex-col justify-between">
                <div>
                    ...
                    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
                        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
                            <div>
                                <h1 className="text-xl font-bold tracking-tight text-slate-900">Enterprise Network Security System</h1>
                            </div>
                ...
                <footer className="border-t border-slate-200/80 bg-white py-6">
                    <div className="mx-auto max-w-6xl px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold text-slate-500">
                        <div className="flex items-center gap-2">
                            <span>© 2026 Enterprise Network Security System.</span>
                            <span className="h-3 w-px bg-slate-200"></span>
                            <span>Author: <strong className="text-slate-800 font-semibold">Akshu Panchal</strong></span>
                        </div>
                        <div className="flex items-center gap-4">
                            <a href="mailto:panchalchakshu0@gmail.com" className="text-slate-600 hover:text-slate-900 transition-colors flex items-center gap-1.5">
